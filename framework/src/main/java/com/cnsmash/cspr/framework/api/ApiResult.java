...
package com.cnsmash.cspr.framework.api;
...
public class ApiResult<T> implements Serializable {
    ...
    public static <T> ApiResult<T> resultRequest(ApiCode apiCode,String message,T data){
    ...
    public static ApiResult<String> failRequest(String message){
        return resultRequest(ApiCode.PARAMETER_CANNOT_BE_EMPTY,message,null);
    }
